	...
	<div class="container-fluid  dashboard-content">
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="card">
					<h5 class="card-header">List of Documents <a href="<?php echo base_url('kebelebulkupload') ?>" class="btn btn-sm btn-outline-success pull-right float-right"><i class="fa fa-upload"></i> Bulk Upload Document</a></h5>
					<div class="card-body">
								...
								foreach ($documents	as $document) :	$no++; ?>
									<tr>
										...
										<?php $role = $this->session->userdata('role');
										 if($role==5){
										?>
										<a href="#" data-toggle="modal" data-target="#RequestDocument<?php echo $document->carta_number; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Attach Document" class="btn btn-sm btn-warning">
