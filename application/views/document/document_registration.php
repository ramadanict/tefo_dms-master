			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="card" style="border-color: red">
					...
					<div class="card-body">
						...
						<?php endif; ?>
						<form action="<?php echo base_url('DocumentRegistrationController/save_document') ?>"
							...
							<div class="row">
								...
								<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 ">
									...
									<label for="validationCustom01" style="font-size: 20px; color: black">City</label>
									<select name="city_name" class="form-control">
										<option value="">----select City Admin----</option>
										<?php foreach ($this->stm->getCityAdmin() as $cityadmin) { ?>
											<option value="<?php echo $cityadmin->city_name; ?>"><?php echo $cityadmin->city_name; ?></option>
										<?php } ?>
									</select>
									<small><?php echo form_error('cityadmin') ?></small>
								</div>
								<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 ">

									<label for="validationCustom01"
										   style="font-size: 20px; color: black">Subcity</label>
									<select name="subcity_name" class="form-control">
										<option value="">----select SubCity----</option>
										<?php foreach ($this->stm->getSubCity() as $subcity) { ?>
											<option value="<?php echo $subcity->subcity_name; ?>"><?php echo $subcity->subcity_name; ?></option>
										<?php } ?>
									</select>
									<small><?php echo form_error('subcity') ?></small>
								</div>
								<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 ">
									<br>
